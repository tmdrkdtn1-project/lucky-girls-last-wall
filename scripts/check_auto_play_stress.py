...
must("summon never restarts loop", "function performSummon()" in html and "scheduleBattleRender()" in html and "if(paused||currentScreen!==\'battle\'||activeBattleModal())return false;" in html)
