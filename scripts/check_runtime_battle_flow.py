...
checks={
 ...
 "prep start wired": "prepDeployCount()<1" in h and "$('start').click()" in h,
 "manual prep grid": 'id="prepDeployGrid"' in h and "data-prep-slot" in h,
 "free prepared units": "paid:0" in h and "count>=5" in h,
